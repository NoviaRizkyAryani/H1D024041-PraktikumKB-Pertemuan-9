...
def run_ga(jumlah_generasi, jumlah_populasi, prob_crossover, prob_mutasi, kapasitas_tas):
    ...
    Args:
        jumlah_generasi (int): Jumlah generasi untuk evolusi
        jumlah_populasi (int): Jumlah individu dalam setiap generasi
        prob_crossover (float): Probabilitas crossover (0-1)
        prob_mutasi (float): Probabilitas mutasi (0-1)
    ...
    plt.plot(range(1, jumlah_generasi+1), best_fitness_list, color='blue', label='Fitness Tertinggi', linewidth=2)
    plt.plot(range(1, jumlah_generasi+1), worst_fitness_list, color='yellow', label='Fitness Terendah', linewidth=2)
    plt.plot(range(1, jumlah_generasi+1), avg_fitness_list, color='red', label='Fitness Rata-rata', linewidth=2)
    ...
    print("\n" + "="*50)
    print("HASIL OPTIMASI KNAPSACK DENGAN ALGORITMA GENETIKA")
    print("="*50)
    print(f"Nilai Fitness Terbaik: {selected_value}")
    print(f"Total Bobot: {selected_weight}")
    print(f"Kapasitas Tas: {kapasitas_tas}")
