...
def inisialisasi_populasi(jumlah_populasi, jumlah_gen):
    """
    Membangkitkan populasi awal secara acak untuk Algoritma Genetika.
    
    Args:
        jumlah_populasi (int): Jumlah individu dalam populasi awal
        jumlah_gen (int): Jumlah gen dalam setiap kromosom
    
    Returns:
        list: List berisi kromosom individu
    """
    populasi = []
